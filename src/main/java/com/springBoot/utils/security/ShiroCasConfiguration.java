...
public class ShiroCasConfiguration {
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager, CasFilter casFilter, UserService userService, UserMapper userMapper) {
